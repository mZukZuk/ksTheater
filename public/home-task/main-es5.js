...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(moviesService) {
    ...
    DashboardComponent.prototype.doFilter = function (value) {
...
var MovieDetailsComponent = /** @class */ (function () {
    function MovieDetailsComponent(moviesService, route) {
        this.moviesService = moviesService;
        this.route = route;
...
var DurationPipe = /** @class */ (function () {
    ...
    DurationPipe.prototype.transform = function (value) {
        var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](value.match(/(?:(\d+)h)?(?:(\d+)m)?/), 3), _ = _a[0], hours = _a[1], mins = _a[2];
        return [hours || 0, mins || 0].map(function (val) {
            if (val.length < 2) {
                return '0' + val;
            }
            return val;
...
var MoviesService = /** @class */ (function () {
    ...
    MoviesService.prototype.getMovies = function () {
        var _this = this;
        this.http.get(this.MOVIES_URL).subscribe(function (data) {
            _this.movies$.next(data.map(function (movie) {
                movie.synopsis = _this.clearString(movie.synopsis); // remove weird comment at
                // the end of the synopsis
                return movie;
            }));
        }, function (error) {
            _this.movies$.error(error);
        });
    };
    MoviesService.prototype.getMoviesObservable = function () {
        return this.movies$.asObservable();
    };
    MoviesService.prototype.clearString = function (str) {
        if (str) {
